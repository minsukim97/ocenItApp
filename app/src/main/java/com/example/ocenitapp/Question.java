...
public class Question extends AppCompatActivity implements AbsListView.OnScrollListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (id) {
                    case R.id.navigation_Introduce:
                        Toast.makeText(Question.this, "같은 메뉴 입니다.", Toast.LENGTH_LONG).show();
                        break;

                    case R.id.navigation_item_Member:
                        Toast.makeText(Question.this, menuItem.getTitle(), Toast.LENGTH_LONG).show();
                        break;
        ...
        listView = (ListView) findViewById(R.id.listview_r5);
        ...
        button1.setOnClickListener(new Button.OnClickListener(){
         ...
         public void onClick(View view){
             Intent write_intent = new Intent(Question.this, Write_question.class);
    ...
    private class phpdo extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
...

            {
                ...
                android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(Question.this);
